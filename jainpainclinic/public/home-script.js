...
(function () {
  ...
  nav.addEventListener('click', function (e) {
    if (e.target.tagName === 'A' && !e.target.closest('.nav-dropdown > a')) {
  ...
  nav.querySelectorAll('.nav-dropdown > a').forEach(function (trigger) {
...
(function () {
  ...
  function setActive(button, options) {
    ...
    if (readMore) readMore.href = content.url;
    switchBgImage(key);
